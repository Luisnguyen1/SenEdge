# Kế hoạch Thực hiện Dự án IoT-AI Retail Assistant

## 1. Thông tin Team

### 1.1 Thành viên và Chuyên môn
...
## 2. Timeline và Milestones

### Week 1-2: Setup và Planning
```mermaid
gantt
...
### 3.1 IoT Engineer 1
#### Week 1-2
- Cài đặt và cấu hình BG220-EK beacons
- Setup EFR32MG21 mesh network
- Viết firmware cơ bản cho các thiết bị

#### Week 3-4
- Phát triển firmware đầy đủ
- Tối ưu hóa power management
- Cấu hình mesh networking
...
### 3.2 IoT Engineer 2
#### Week 1-2
- Setup XG26-DK2608A và XG24-EK2703A
...
- Thiết lập real-time monitoring
